...
namespace Azure
{
    ...
    {
        private const string SubscriptionKey = "a60f912a42de408ead58812a6f5f834b"; // put your Azure subscription key here
        private const string Region = "southeastasia"; // put your Azure region here
